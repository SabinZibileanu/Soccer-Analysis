...
st.subheader('defensiveErrorRates: It takes into account the number of goals that a team conceded across the season reported to the number of total successful actions across the season. A low error rate indicates that a team is efficient in defense and not error prone. A high error rate indicates that a team is inefficient in defense and can be forced into mistakes', divider=True)
